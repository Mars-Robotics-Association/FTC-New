...
public class ControllerInputManagerOld extends External //TODO eventually refactor
{
    //REFERENCES
    ...
    private List<ControllerInputListenerOld> listeners = new ArrayList<ControllerInputListenerOld>();

    //Add a new listener
    public void addListener(ControllerInputListenerOld toAdd) {
        listeners.add(toAdd);
    }
    ...
    public void A1Pressed() {
        // Notify listeners
        for (ControllerInputListenerOld CIL : listeners)
            CIL.A1Pressed();
    }
    ...
    public ControllerInputManagerOld(OpMode setOpMode){
        opMode = setOpMode;
    }
